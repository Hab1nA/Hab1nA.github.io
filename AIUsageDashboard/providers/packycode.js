/**
 * Packycode provider implementation.
 * Third-party AI API relay.
 */
import { ProviderBase } from '../provider-base.js';
import { getProviderConfig, hasProviderConfig } from '../config.js';

export class PackycodeProvider extends ProviderBase {
  constructor() {
    super();
    this.id = 'packycode';
    this.name = 'Packycode';
      ...
      fields: [
        {
          ...
          type: 'password',
          required: true,
          placeholder: '输入你的 Packycode API Key'
        },
        {
          id: 'apiBase',
          label: 'API 基础地址',
          ...
          default: 'https://api.packycode.com'
        }
      ]
    };
  }
  ...
  async fetchTodayUsage() {
    ...
    const config = getProviderConfig(this.id);
    const base = config.apiBase || 'https://api.packycode.com';
    
    try {
      // Packycode usage endpoint
